    ...
    return (
        <div className="px-4 py-10">
            <div className="mb-8">
                ...
                <div className="mt-5">
                    <h1 className="tex-3xl font-bold text-gray-900">Galaxy S50</h1>
                    ...
                    <div className="flex items-center justify-between space-x-2">
                        ...
                        <button className="p-3 rounded-md flex items-center justify-center text-gray-400 hover:bg-gray-100 rounded-md">
                            <svg
                                className="h-6 w-6 "
            ...
            <div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                    {[1, 2, 3, 4, 5, 6].map((_, i) => (
                        <div key={i}>
                            <div className="h-56 w-full bg-slate-300 mb-3" />
