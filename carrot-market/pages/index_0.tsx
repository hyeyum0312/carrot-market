...
const Home: NextPage = () => {
  return (
    <div className="dark bg-slate-400 place-content-center py-20 px-10 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className=" dark:bg-black bg-white p-6 rounded-3xl flex flex-col justify-between shadow-xl sm:bg-red-400 sm:hover:text-red-500 md:bg-yellow-500 lg:bg-indigo-400 xl:bg-blue-200 2xl:bg-amber-600 dark:sm:bg-black dark:md:bg-black dark:lg:bg-black dark:xl:bg-black dark:2xl:bg-black dark:bg-red-500">
          ...
          <ul className="dark:text-white dark:bg-black">
              {[1,2,3].map((i)=>(
                <div key={i} className="flex justify-between my-2 odd:bg-yellow-50 even:bg-red-50 dark:text-white dark:odd:bg-black dark:even::bg-black ">
                    <span className="text-[#DCDCDD] text-[30px] text-gray-500 dark:text-white dark:bg-black">Grey Chair</span>
          ...
          <div className="mt-2 pt-2 border-t-2 flex justify-between">
              <span>total</span>
              <span className="font-semibold dark:text-white dark:bg-black">$10</span>
          </div>
          <div className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-500
          hover:text-black
          active:bg-yellow-500
          focus:bg-red-500
          dark:border-white dark:bg-amber-600 dark:text-white">checkout</div>
      </div>
