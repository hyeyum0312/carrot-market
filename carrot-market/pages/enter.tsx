        ...
        <div className="mt-16 px-4">
            ...
            <div className="mt-8">
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-2 mt-8 w-full border-b">
                        <button className={cls('pb-4 font-medium border-b-2',method ==='email'? 'border-b-2 text-orange-400 border-orange-500' : 'border-transparent text-gray-500')} onClick={onEmailClick}>Email</button>
                ...
                <div className="mt-8">
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-2">
                        <button className="flex justify-center items-center py-2 border border-gray-300 rounded-md bg-white font-medium text-gray-500 font-sm hover:bg-gray-50">
                            <svg
                                className="w-5 h-5"
                                aria-hidden="true"
                                fill="currentColor"
